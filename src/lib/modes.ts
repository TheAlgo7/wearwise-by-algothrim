...
export const DEFAULT_MODES: Mode[] = [
  ...
  { id: 'home',     label: 'Home',      hint: 'Comfy · chill · no pressure',     rules: { min_formality: 1, max_formality: 2, required_vibes_any: ['casual','lounge','gym'] }, sort_order: 2 },
  ...
  { id: 'impress',  label: 'Impress',   hint: 'Signature combos only',           rules: { min_formality: 3, favor_signature: true, avoid_recently_worn_days: 7 }, sort_order: 8 },
