 ...
 *
 * Bypasses RLS by design. RLS is ENABLED with anon limited to SELECT on core
 * tables (items, outfits, style_profile, modes, categories) — all writes must
 * go through API routes using this client. The browser anon key is read-only.
 */
