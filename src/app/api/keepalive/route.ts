 ...
 * read per day keeps it counted as active. WearWise Go pings the same shared
 * project on an opposite schedule for redundancy.
 */
export async function GET() {
  ...
  const res = await fetch(`${url}/rest/v1/items?select=id&limit=1`, {
